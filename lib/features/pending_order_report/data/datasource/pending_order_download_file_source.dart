...
class PendingOrderDownloadFileSource {
  final NetworkService networkService;
  final NetworkInfo networkInfo;
  PendingOrderDownloadFileSource(this.networkService, this.networkInfo);

  Future<PendingDownloadFileModel> fetchPendingOrderDownloadFile(
