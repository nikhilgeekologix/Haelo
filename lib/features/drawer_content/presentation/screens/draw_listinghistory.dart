...
class ListingHistory extends StatefulWidget {
  const ListingHistory({Key? key}) : super(key: key);

  @override
  State<ListingHistory> createState() => _ListingHistoryState();
}

class _ListingHistoryState extends State<ListingHistory> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (orderHistoryData!=null) ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: mpHeadLine14(
                                      textColor: AppColor.bold_text_color_dark_blue, fontWeight: FontWeight.w500),
                                ),
                                const SizedBox(
                                  height: 12,
                                ),
                      ...
                      ? SizedBox()
                      : NoDataAvailable(
                      "Your date of history will be shown here."),
                ],
              ),
            ),
          ),
