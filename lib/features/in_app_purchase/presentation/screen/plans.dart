                        ...
                        if (model.result == 1 && model.data != null) {
                          for (int i = 0;
                            ...
                            if (model.data!.l1Month![i].planName ==
                              ...
                              print("for platinum");
                              var newIdx = _products.indexWhere((element) =>
                                  element.id == Constants.oneMonthPlatinum &&
                                  element.price != "Free");
                          ...
                          for (int i = 0;
                            ...
                            if (model.data!.l12Month![i].planName == "gold") {
                              var newIdx = _products.indexWhere((element) =>
                                  element.id == Constants.twelveMonthGold);
                              if (newIdx != -1) {
                                var newPrice = _products[newIdx].rawPrice;
                            ...
                            if (model.data!.l12Month![i].planName == "silver") {
                              var newIdx = _products.indexWhere((element) =>
                                  element.id == Constants.twelveMonthSilver);
                              if (newIdx != -1) {
                                var newPrice = _products[newIdx].rawPrice;
                                model.data!.l12Month![i].planAmount =
                                    ((newPrice)).toStringAsFixed(2);
                            ...
                            if (model.data!.l12Month![i].planName ==
                                "platinum") {
                              var newIdx = _products.indexWhere((element) =>
                                  element.id == Constants.twelveMonthPlatinum);
                              if (newIdx != -1) {
                                var newPrice = _products[newIdx].rawPrice;
                                model.data!.l12Month![i].planAmount =
                                    ((newPrice)).toStringAsFixed(2);
                          ...
                          return Column(
                            children: [
                              ...
                              Expanded(
                                ...
                                children: [
                                  if (model.data!.l1Month!.isNotEmpty)
                                    PlanList(model.data!.l1Month),

                                  if (model.data!.l6Month!.isNotEmpty)
                                    PlanList(model.data!.l6Month),
