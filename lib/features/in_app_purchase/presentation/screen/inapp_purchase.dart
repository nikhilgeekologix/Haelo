...
// // import 'package:iaphub_flutter/iaphub.dart';
...
// const String _kSilverSubscriptionId = 'test_silver_1_month';
// const String _kGoldSubscriptionId = 'test_gold_1_month';
//
//
...
//       Constants.twelveMonthGold,
//       Constants.twelveMonthSilver,
//     ];
...
//
//     final Set<String> subscriptionIds = {'test_silver_1_month'};
//
...
//       print('Subscription ID: ${product.id}');
//       // ...
//     }
//   }
//
...
//       print("86 productDetailResponse.error");
//       setState(() {
...
//       print("101 productDetailResponse.error");
//       setState(() {
...
//     print("116 consumables ${consumables.length}");
//     setState(() {
//       _isAvailable = isAvailable;
//       _products = productDetailResponse.productDetails;
//       _notFoundIds = productDetailResponse.notFoundIDs;
...
//       print("id ${_products[i].id}");
//       print("title ${_products[i].title}");
//       print("element ${_products[i].price}");
//       print("element ${_products[i].rawPrice}\n\n");
//     }
//   }
//
//   @override
...
//     final List<String> consumables = await ConsumableStore.load();
//     print("405 consumables ${consumables.first}");
//     setState(() {
//       _consumables = consumables;
//     });
//   }
...
//       print("422 purchaseDetails.purchaseID ${purchaseDetails.purchaseID}");
//       final List<String> consumables = await ConsumableStore.load();
//       print("423 consumables ${consumables.length}");
//       setState(() {
//         _purchasePending = false;
//         _consumables = consumables;
//         print("426 consumables ${_consumables.first}");
//       });
//     } else {
//       print("inelse ${purchaseDetails.purchaseID}");
//       setState(() {
...
//     print("418 purchaseDetailsList $purchaseDetailsList");
//
//     for (final PurchaseDetails purchaseDetails in purchaseDetailsList) {
//       print("419 purchaseUpdated ${purchaseDetails.status}");
