...
class OrderCmtHistoryFilter extends StatefulWidget {
  final filterCallback;
  final selected;
  const OrderCmtHistoryFilter(this.filterCallback,this.selected,{Key? key}) : super(key: key);

  @override
  State<OrderCmtHistoryFilter> createState() => _CasesBottomSheetState();
}

class _CasesBottomSheetState extends State<OrderCmtHistoryFilter> {
  List decisionStatus = ["Order judgement File available","No Order judgement File available", "Comments available", "Comments not available"];
  String grpValue = "";
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Text(
                    ...
                    grpValue.isNotEmpty?AppColor.primary:
                      ...
                      child: RadioListTile(
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            selectedValue = decisionStatus[index];//value.toString();
