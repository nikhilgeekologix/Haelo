...
class _GoogleDriveScreenState extends State<GoogleDriveScreen> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //     int index=widget.fileList.files!.toList().indexOf(e);
                  ...
                  //             onTap: () async {
                  //               await _onItemTap(file, widget.authenticateClient, context);
                  //             },
                  //             child: DriveFileCard(
                  ...
                  //       //   || file.mimeType!.contains(".png")
                  //       //   || file.mimeType!.contains(".jpg")
                  //       //   || file.mimeType!.contains(".pdf")
                  //       //   || file.mimeType!.contains(".jpeg")
                  //       //   || file.mimeType!.contains(".xls")
                  //       //   || file.mimeType!.contains(".xlsx")
                  //       //   ?
                  //       DriveFileCard(
                  //         index,widget.fileList
                  //     );
  ...
  Future<void> _onItemTap(File file, var authenticateClient, context) async {
    setState(() {
      isLoading = true;
    });
