...
class StayDropDown extends StatelessWidget {
  final callbackToHistory;
  final String alreadySelectedOnHistory;
  StayDropDown(this.callbackToHistory, this.alreadySelectedOnHistory) : super();
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          margin: EdgeInsets.fromLTRB(58, 120, 0, 5),
